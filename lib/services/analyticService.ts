...
class AnalyticsService {
  ...
  private normalizeEngagementData(data: ChartDataPoint[], userType: 'user' | 'agent'): ChartDataPoint[] {
    // If no data, return empty array to trigger "No data" state in UI
  ...
  // ─── Admin Short-Term Analytics ───────────────────────────────────────────

  async getAdminKPIs(params?: DateRangeParams) {
    const response = await apiClient.request({
      method: 'GET',
  ...
  async getAdminRevenue(params?: DateRangeParams) {
    const response = await apiClient.request({
      method: 'GET',
  ...
  async getAdminOccupancy(params?: DateRangeParams) {
    const response = await apiClient.request({
      method: 'GET',
  ...
  async getAdminTopProperties(params?: DateRangeParams & { limit?: number }) {
    const response = await apiClient.request({
      method: 'GET',
      url: '/analytics/admin/top-properties',
      params,
    });
    return response;
  }

  async getAdminCityPerformance(params?: DateRangeParams) {
    const response = await apiClient.request({
      method: 'GET',
      url: '/analytics/admin/city-performance',
      params,
    });
    return response;
  }

  async getAdminHostPerformance(params?: DateRangeParams & { limit?: number }) {
    const response = await apiClient.request({
      method: 'GET',
      url: '/analytics/admin/host-leaderboard',
      params,
    });
    return response;
  }
