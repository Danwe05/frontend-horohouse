...
export function OnboardingFlow() {
  ...
  const initializeOnboarding = async () => {
    try {
      ...
      // We add +1 for the CompletionStep which is not counted in the rendered steps logic usually
      // but needed for the progress bar and nextStep checks
      const totalSteps = user?.role === 'agent' ? 6 : 5;
