    ...
    <section className="bg-white py-24 px-6 lg:px-10 border-t border-gray-100" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          <h2 className="text-[36px] md:text-[44px] font-bold tracking-tight text-gray-900 mb-6">
            Protected from start to finish.
          </h2>
          <p className="text-[18px] md:text-[20px] text-gray-500 font-light leading-relaxed">
