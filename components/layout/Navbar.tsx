...
export default function Navbar({ showOnlyWhenAuthenticated = false }: NavbarProps) {
  ...
  const getNavLinks = () => {
    ...
    const sellLink = { href: '/properties/sell', label: 'Sell', icon: Building };
            ...
            <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 p-2" align="end" forceMount>
                  ...
                  {user?.role === 'agent' && (
                    <DropdownMenuItem onClick={() => router.push('/properties/new')} className="cursor-pointer">
