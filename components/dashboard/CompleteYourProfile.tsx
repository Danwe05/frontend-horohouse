    ...
    <div className="bg-white rounded-xl border border-gray-300 -sm p-4 flex items-center justify-between">
      ...
      <div className="flex gap-4">
        <Image
          ...
          width={avatarSize}
          height={avatarSize}
          className={`rounded-full object-cover ${variant === "small" ? "h-9 w-9" : "h-12 w-12"}`}
        />
        <div className="space-y-2">
          ...
          <button
            className={`mt-2 bg-[#2B95F6] text-white rounded-md hover:bg-[#0052cc] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition ${buttonSize}`}
          >
            Complete Now
          </button>
        </div>
