...
const regularUserItems = [
  ...
  { icon: Heart, label: "Saved Properties", path: "/dashboard/saved", badge: null, activeKey: "saved" },
                ...
                <>
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <button
                      ...
                      className="p-2 rounded-lg hover:bg-muted/50 transition-all duration-200 group/notification relative hover:scale-110"
                      aria-label="Notifications"
                    >
                      <Bell className="w-4 h-4 text-muted-foreground group-hover/notification:text-blue-600 transition-colors" />
                      {unreadNotifications > 0 && (
                        <div className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-red-500 rounded-full border border-background animate-pulse" />
                      )}
                    </button>
                    <ChevronDown className={cn(
                      "w-4 h-4 text-muted-foreground transition-all duration-300 group-hover/button:text-foreground",
                      showLogout && "rotate-180 text-blue-600"
                    )} />
                  </div>
                </>
              )}
