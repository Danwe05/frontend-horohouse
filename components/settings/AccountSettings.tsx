    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your personal data, exports, and account security.</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-gray-400 flex items-center gap-2">
              <Database className="w-4 h-4" /> Data Portability
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-between h-48 hover:border-blue-400 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1 mb-4">Download a JSON copy of your messages, settings, and history.</p>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-between h-48 hover:border-green-400 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1 mb-4">Restore your account from a previous HoroHouse backup file.</p>
          ...
          <section className="space-y-4">
             ...
             <div className="bg-white rounded-xl border border-gray-200 overflow-hidden divide-y divide-gray-100 shadow-sm">
                <ActionRow 
                   ...
                   desc="Remove all saved searches and recent queries" 
                ...
                <ActionRow 
                   ...
                   desc="Remove browsing history and interaction logs" 
                ...
                <ActionRow 
                   ...
                   desc="Save a secure snapshot of your current state" 
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-red-50 rounded-2xl p-6 border border-red-100">
            ...
            <p className="text-xs text-red-700/80 mb-6 leading-relaxed">
              These actions are destructive. Please ensure you have exported your data before proceeding.
            </p>
          ...
          <div className="bg-gray-50 p-4 rounded-xl text-xs text-gray-500 leading-relaxed">
             <strong>Privacy Note:</strong> When you delete data, it is removed from our live servers immediately. Backups are retained for 30 days before permanent deletion.
          </div>
        </div>
      ...
      {showDeactivateModal && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95">
            ...
            <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Pause your account?</h3>
            <p className="text-gray-500 text-center text-sm mb-6">
              Your profile will be hidden effectively immediately. You can reactivate anytime by simply logging back in.
            </p>
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder="Optional: Tell us why you're taking a break..."
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" onClick={() => setShowDeactivateModal(false)} className="h-11">Cancel</Button>
        ...
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95 border-t-4 border-red-600">
            <div className="flex items-start gap-4 mb-4">
               ...
               <div>
                  <h3 className="text-lg font-bold text-gray-900">Nuke all data?</h3>
                  <p className="text-sm text-gray-500 mt-1">
                    This action is <span className="font-bold text-red-600">irreversible</span>. Everything listed below will be permanently destroyed.
                  </p>
               </div>
            </div>
            ...
            <div className="bg-red-50 rounded-xl p-4 mb-6">
               <ul className="space-y-2 text-sm text-red-800">
                 <li className="flex items-center gap-2"><Trash2 className="w-3 h-3" /> Search history & favorites</li>
                 <li className="flex items-center gap-2"><Trash2 className="w-3 h-3" /> All messages (both sides)</li>
                 <li className="flex items-center gap-2"><Trash2 className="w-3 h-3" /> Profile settings & preferences</li>
               </ul>
            </div>
